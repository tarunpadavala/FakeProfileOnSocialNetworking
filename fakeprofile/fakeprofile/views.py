...
def predict(request):
    if request.method == 'POST':
        ...
        if model_name == 'xgboost':
            model = load(r"D:\fakeprofile\fakeprofile\fakeprofile\models\twitter\xg_model.ckpt")
        else:
            model = load(r"D:\fakeprofile\fakeprofile\fakeprofile\models\twitter\model.ckpt")
...
def get_profile_info(request):
    if request.method == 'POST':
        try:
            ...
            if model_name == 'xgboost':
                model = load(r"D:\fakeprofile\fakeprofile\fakeprofile\models\instagram\xgboost_optimized_model.pkl")
            else:
                model = load(r"D:\fakeprofile\fakeprofile\fakeprofile\models\instagram\model.pkl")
...
def FaceBookPredict(request):
    if request.method == 'POST':
        ...
        if model_name == 'xgboost':
             model = load(r"D:\fakeprofile\fakeprofile\fakeprofile\models\facebook\xgb_model.pkl")
        else:
            model = load(r"D:\fakeprofile\fakeprofile\fakeprofile\models\facebook\rf_model.pkl")
